...
public class GameSession {
    ...
    public GameSession(GameBoard gameBoard, String playerName, GamePersistenceManager persistenceManager) {
        ...
        System.out.println("Betölthető állapot: " + (persistenceManager != null));
    ...
    public void start() {
        ...
        while (!gameBoard.isGameOver()) {
            System.out.println("Mit szeretnél tenni? (1: lép, 2: fordul jobbra, 3: fordul balra, 4: lő," +
                    " 5: aranyat felszed, 6: fordul fel, 7: játék mentése)");
    ...
    private void checkGameStatus() {
        ...
        if (hero.hasGold() && hero.getRow() == gameBoard.getStartingRow() && hero.getColumn() == gameBoard.getStartingColumn()) {
            ...
            System.out.println(playerName + ", vége a játéknak, vesztettél.");
        }
    }
